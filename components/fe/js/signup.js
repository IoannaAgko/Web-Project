    ...
    $(document).ready(function() {
        ...
        if (submited) {
            ...
            $.ajax({
                    ...
                    url: '/api/users/create', // the url where we want to POST
                    ...
                    error: function(xhr, status, error) {
                        ...
                        if (res.user === true && res.email === false) {
                            ...
                            $('#email').removeClass('valid_hate');
                            $('#email').addClass('invalid_love'); 
                            $('#name-group').append('<div id="error1" class="love_yes"> Username or email already exists. Pleasy try again</div>'); 
